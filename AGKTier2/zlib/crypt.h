...
//PE: Need to use (unsigned int) instead of (long,unsigned long,unsignd) everywhere.
...
//PE: Our zlib use 2 parameters so... (decrypt_byte dont actually use pcrc_32_tab)
