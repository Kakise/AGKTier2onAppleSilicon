...
#define AGK_JSON_OBJECT		1
#define AGK_JSON_ARRAY		2
#define AGK_JSON_STRING		3
#define AGK_JSON_NUMBER		4
#define AGK_JSON_BOOL		5
...
namespace AGK
{
	...
	class JSONObject : public JSONElement
	{
		public:
			...
			int GetType() { return AGK_JSON_OBJECT; } // 0=Undefined, 1=Object, 2=Array, 3=String, 4=Number, 5=Bool
	...
	class JSONArray : public JSONElement
	{
		public:
			...
			int GetType() { return AGK_JSON_ARRAY; } // 0=Undefined, 1=Object, 2=Array, 3=String, 4=Number, 5=Bool
	...
	class JSONString : public JSONElement
	{
		public:
			...
			int GetType() { return AGK_JSON_STRING; } // 0=Undefined, 1=Object, 2=Array, 3=String, 4=Number, 5=Bool
	};
	...
	class JSONNumber : public JSONElement
	{
		public:
			...
			int GetType() { return AGK_JSON_NUMBER; } // 0=Undefined, 1=Object, 2=Array, 3=String, 4=Number, 5=Bool
	};
	...
	class JSONBool : public JSONElement
	{
		public:
			...
			int GetType() { return AGK_JSON_BOOL; } // 0=Undefined, 1=Object, 2=Array, 3=String, 4=Number, 5=Bool
	};
