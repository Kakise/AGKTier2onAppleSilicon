...
RagDoll::RagDoll( int ragdollID ) : BaseItem( ragdollID )
{
	...
	m_linearDamping = 0.08;
	m_angularDamping = 0.95;
	m_linearSleepingThresholds = 1.8;
	m_angularSleepingThresholds = 2.8;
	m_deactivationTime = 0.8;
	m_modelTotalVolume = 0.0;
}
...
{
	for(int i = 0; i < ragDollManager.GetCount(); i++)
	{
