...
struct b2FixtureDef
{
	...
	b2Shape* shape; 
	bool localShapeMemory; // AGK sets this to false to control the shape memory
...
protected:
	...
	b2Shape* m_shape;
	bool m_localShapeMemory; // AGK sets this to false to control the shape memory
