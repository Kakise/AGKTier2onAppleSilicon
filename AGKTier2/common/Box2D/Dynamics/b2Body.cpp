...
void b2Body::SetType(b2BodyType type)
{
	...
	// Delete the attached contacts. // added in Box2D 2.3.2
...
b2Fixture* b2Body::CreateFixture(b2Shape* shape, float32 density)
{
	b2FixtureDef def;
	def.shape = shape;
	def.density = density;
...
void b2Body::DestroyFixture(b2Fixture* fixture)
{
	...
	fixture->m_body = NULL; // moved in Box2D 2.3.2
	fixture->m_next = NULL;
