...
void b2GearJoint::InitVelocityConstraints(const b2SolverData& data)
{
	...
	if ( m_bodyA->m_type == b2_staticBody ) m_indexA = data.staticIndexArray->FindBody( m_bodyA );
	if ( m_bodyB->m_type == b2_staticBody ) m_indexB = data.staticIndexArray->FindBody( m_bodyB );
	if ( m_bodyC->m_type == b2_staticBody ) m_indexC = data.staticIndexArray->FindBody( m_bodyC );
	if ( m_bodyD->m_type == b2_staticBody ) m_indexD = data.staticIndexArray->FindBody( m_bodyD );
